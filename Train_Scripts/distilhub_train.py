...
from models.distilhub_1 import HubertModule
...
#audio model
#first test will fully unfrozen
audio_model=HubertSmall()
#second test with gradual unfreezing
#audio_model=HubertModule()
...
checkpoint_callback = ModelCheckpoint(
    ...
    dirpath=  "/share/users/student/m/mnsiah/final_results/distilhubv2_chkpt_1",    # Directory to save checkpoints
    filename="distil_hub-{epoch:02d}-{val_min_f1:.2f}",  # Checkpoint file naming
...
trainer = pl.Trainer(
    ...
    default_root_dir="/share/users/student/m/mnsiah/final_results/distilhubv2_logs_1",
